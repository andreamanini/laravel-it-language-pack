<?php
    ...
    return [
        ...
        */
        ...
        'prohibited' => "':attribute' è vietato.",
        'prohibited_if' => "':attribute' è vietato quando :other è :value.",
        'prohibited_unless' => "':attribute' è vietato a meno che :other non si in :values.",
        'prohibits' => "':attribute' vieta a :other di essere presente.",
